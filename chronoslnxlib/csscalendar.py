...
class CSSCalendar(QtWidgets.QWidget):
    ...
    def dayFill(self, day):
        return self.weekdayBGs[day-1]

    sundayFill = QtCore.pyqtProperty(
        "QBrush",
        lambda self: self.dayFill(QtCore.Qt.Sunday),
        lambda self, fill: self.setDayFill(QtCore.Qt.Sunday, fill)
    )
    mondayFill = QtCore.pyqtProperty(
        "QBrush",
        lambda self: self.dayFill(QtCore.Qt.Monday), 
        lambda self, fill: self.setDayFill(QtCore.Qt.Monday, fill)
    )
    tuesdayFill = QtCore.pyqtProperty(
        "QBrush",
        lambda self: self.dayFill(QtCore.Qt.Tuesday), 
        lambda self, fill: self.setDayFill(QtCore.Qt.Tuesday, fill)
    )
    wednesdayFill = QtCore.pyqtProperty(
        "QBrush",
        lambda self: self.dayFill(QtCore.Qt.Wednesday), 
        lambda self, fill: self.setDayFill(QtCore.Qt.Wednesday, fill)
    )
    thursdayFill = QtCore.pyqtProperty(
        "QBrush",
        lambda self: self.dayFill(QtCore.Qt.Thursday), 
        lambda self, fill: self.setDayFill(QtCore.Qt.Thursday, fill)
    )
    fridayFill = QtCore.pyqtProperty(
        "QBrush",
        lambda self: self.dayFill(QtCore.Qt.Friday), 
        lambda self, fill: self.setDayFill(QtCore.Qt.Friday, fill)
    )
    saturdayFill = QtCore.pyqtProperty(
        "QBrush",
        lambda self: self.dayFill(QtCore.Qt.Saturday), 
        lambda self, fill: self.setDayFill(QtCore.Qt.Saturday, fill)
    )

    sundayFG = QtCore.pyqtProperty(
        "QBrush",
        lambda self: self.dayFG(QtCore.Qt.Sunday), 
        lambda self, fill: self.setDayFG(QtCore.Qt.Sunday, fill)
    )
    mondayFG = QtCore.pyqtProperty(
        "QBrush",
        lambda self: self.dayFG(QtCore.Qt.Monday), 
        lambda self, fill: self.setDayFG(QtCore.Qt.Monday, fill)
    )
    tuesdayFG = QtCore.pyqtProperty(
        "QBrush",
        lambda self: self.dayFG(QtCore.Qt.Tuesday), 
        lambda self, fill: self.setDayFG(QtCore.Qt.Tuesday, fill)
    )
    wednesdayFG = QtCore.pyqtProperty(
        "QBrush",
        lambda self: self.dayFG(QtCore.Qt.Wednesday), 
        lambda self, fill: self.setDayFG(QtCore.Qt.Wednesday, fill)
    )
    thursdayFG = QtCore.pyqtProperty(
        "QBrush",
        lambda self: self.dayFG(QtCore.Qt.Thursday), 
        lambda self, fill: self.setDayFG(QtCore.Qt.Thursday, fill)
    )
    fridayFG = QtCore.pyqtProperty(
        "QBrush",
        lambda self: self.dayFG(QtCore.Qt.Friday), 
        lambda self, fill: self.setDayFG(QtCore.Qt.Friday, fill)
    )
    saturdayFG = QtCore.pyqtProperty(
        "QBrush",
        lambda self: self.dayFG(QtCore.Qt.Saturday), 
        lambda self, fill: self.setDayFG(QtCore.Qt.Saturday, fill)
    )
    '''
